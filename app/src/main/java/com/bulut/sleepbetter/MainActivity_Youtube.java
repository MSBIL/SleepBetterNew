...
import static com.bulut.sleepbetter.R.layout.suggestions;
...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks,
    ...
    public void onVideoSelected(YouTubeVideo video) {
        ...
        Log.d(TAG, "Staring video now");
        startService(serviceIntent);
    }

    private void initTimeOutService(Intent serviceIntent) {
        Log.d(TAG, "Setting time out service: ");
        final Intent my_serviceIntent = serviceIntent;
            ...
            public void onCreate() {
                ...
                this.mIntentReceiver = new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        Log.d("TIMEOUT SERIVCE", "BUILDING");
    ...
    public void onPlaylistSelected(List<YouTubeVideo> playlist, int position) {
        ...
        initTimeOutService(serviceIntent);
        Timeout my_timeout = new Timeout();
        my_timeout.start(this);
        /*
        ...
        */
        ...
        stopIntent.putExtra(Config.YOUTUBE_TYPE_PLAYLIST_VIDEO_POS, position);
